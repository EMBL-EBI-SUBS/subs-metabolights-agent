package uk.ac.ebi.subs.metabolights.validator.schema.custom;
...
public class LocalDateCustomSerializer extends StdSerializer<LocalDate> {
    ...
    public void serialize(LocalDate value, JsonGenerator gen, SerializerProvider provider) throws IOException {
        gen.writeString(String.format("%04d",value.getYear()) + "-" + String.format("%02d", value.getMonthValue()) + "-" + String.format("%02d", value.getDayOfMonth()));
    }
}